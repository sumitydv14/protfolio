      ...
      <div className="container-custom py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              I craft innovative digital solutions combining artificial
              intelligence with modern full-stack development. Specialized in
              building scalable, performant applications that push technical
              boundaries.
            </motion.p>
